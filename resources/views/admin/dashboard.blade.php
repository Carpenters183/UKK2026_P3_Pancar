        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                    <span>Menunggu</span>
                    <span class="badge badge-warning">{{ $aspirasiMenunggu }}</span>
                </div>
                ...
                <div class="d-flex justify-content-between mb-3">
                    <span>Diproses</span>
                    <span class="badge badge-info">{{ $aspirasiProses }}</span>
                </div>
                <div class="progress mb-3">
                ...
                <div class="d-flex justify-content-between mb-3">
                    <span>Selesai</span>
                    <span class="badge badge-success">{{ $aspirasiSelesai }}</span>
                </div>
                <div class="progress mb-3">
