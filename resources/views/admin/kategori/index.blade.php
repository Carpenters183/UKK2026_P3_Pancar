            ...
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" id="masterDataTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="kategori-tab" data-toggle="tab"
                            href="#kategori" role="tab">
                            <i class="ph ph-tag"></i> Kategori
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="jurusan-tab" data-toggle="tab"
                            href="#jurusan" role="tab">
                            <i class="ph ph-book"></i> Jurusan
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="kelas-tab" data-toggle="tab"
                            href="#kelas" role="tab">
                            <i class="ph ph-users"></i> Kelas
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="ruangan-tab" data-toggle="tab"
                            href="#ruangan" role="tab">
                ...
                <div class="tab-content" id="masterDataTabContent">
                    ...
                    <div class="tab-pane fade show active" id="kategori" role="tabpanel">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addKategoriModal">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-info">{{ $kategori->aspirasi_count ?? 0 }}</span>
                                        </td>
                                        <td>
                                            <button class="btn btn-info btn-sm" data-toggle="modal"
                                                    data-target="#viewKategoriModal{{ $kategori->id_kategori }}">
                                                <i class="ph ph-eye"></i> Detail
                                            </button>
                                            <button class="btn btn-warning btn-sm" data-toggle="modal"
                                                    data-target="#editKategoriModal{{ $kategori->id_kategori }}">
                                                <i class="ph ph-pencil"></i> Edit
                                            </button>
                                            <button class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#deleteKategoriModal{{ $kategori->id_kategori }}">
                    ...
                    <div class="tab-pane fade" id="jurusan" role="tabpanel">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addJurusanModal">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-info">{{ $jurusan->kelas_count ?? 0 }} Kelas</span>
                                        </td>
                                        <td>
                                            <button class="btn btn-info btn-sm" data-toggle="modal"
                                                    data-target="#viewJurusanModal{{ $jurusan->id_jurusan }}">
                                                <i class="ph ph-eye"></i> Detail
                                            </button>
                                            <button class="btn btn-warning btn-sm" data-toggle="modal"
                                                    data-target="#editJurusanModal{{ $jurusan->id_jurusan }}">
                                                <i class="ph ph-pencil"></i> Edit
                                            </button>
                                            <button class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#deleteJurusanModal{{ $jurusan->id_jurusan }}">
                                                <i class="ph ph-trash"></i> Hapus
                                            </button>
                                        </td>
                                    </tr>
                    ...
                    <div class="tab-pane fade" id="kelas" role="tabpanel">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addKelasModal">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-{{ ($k->siswa_count ?? 0) > ($k->kapasitas ?? 0) ? 'danger' : 'success' }}">
                                                {{ $k->siswa_count ?? 0 }}/{{ $k->kapasitas ?? 0 }}
                                            </span>
                                        </td>
                                        <td>
                                            <button class="btn btn-info btn-sm" data-toggle="modal"
                                                    data-target="#viewKelasModal{{ $k->id_kelas }}">
                                                <i class="ph ph-eye"></i> Detail
                                            </button>
                                            <button class="btn btn-warning btn-sm" data-toggle="modal"
                                            ...
                                            <button class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#deleteKelasModal{{ $k->id_kelas }}">
                                                <i class="ph ph-trash"></i> Hapus
                                            </button>
                                        </td>
                                    </tr>
                    ...
                    <div class="tab-pane fade" id="ruangan" role="tabpanel">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addRuanganModal">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td><span class="badge badge-secondary">{{ $ruangan->kode_ruangan }}</span></td>
                                        <td>{{ $ruangan->nama_ruangan }}</td>
                                        <td>{{ $ruangan->jenis_ruangan }}</td>
                                        <td>{{ $ruangan->lokasi ?? '-' }}</td>
                                        <td>
                                            <span class="badge badge-{{ $ruangan->kondisi == 'Baik' ? 'success' : ($ruangan->kondisi == 'Rusak Berat' ? 'danger' : 'warning') }}">
                                                {{ $ruangan->kondisi }}
                                            </span>
                                        </td>
                                        <td>
                                            <button class="btn btn-info btn-sm" data-toggle="modal"
                                                    data-target="#viewRuanganModal{{ $ruangan->id_ruangan }}">
                                                <i class="ph ph-eye"></i> Detail
                                            </button>
                                            <button class="btn btn-warning btn-sm" data-toggle="modal"
                                                    data-target="#editRuanganModal{{ $ruangan->id_ruangan }}">
                                                <i class="ph ph-pencil"></i> Edit
                                            </button>
                                            <button class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#deleteRuanganModal{{ $ruangan->id_ruangan }}">
                                                <i class="ph ph-trash"></i> Hapus
                                            </button>
                                        </td>
                                    </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="ph ph-eye"></i> Detail Kategori</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
                <p><strong>Nama Kategori:</strong> {{ $kategori->nama_kategori }}</p>
                <p><strong>Deskripsi:</strong> {{ $kategori->deskripsi ?: '-' }}</p>
                <p><strong>Total Aspirasi:</strong> <span class="badge badge-info">{{ $kategori->aspirasi_count ?? 0 }}</span></p>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title"><i class="ph ph-plus-circle"></i> Tambah Kategori Baru</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title"><i class="ph ph-pencil"></i> Edit Kategori</h5>
            ...
            <form action="{{ route('admin.kategori.update', $kategori->id_kategori) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <strong>Perhatian:</strong> Kategori ini sudah digunakan dalam {{ $kategori->aspirasi_count }} aspirasi.
                    </div>
                    @endif
                </div>
                <div class="modal-footer">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title"><i class="ph ph-trash"></i> Hapus Kategori</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="viewJurusanModal{{ $jurusan->id_jurusan }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="ph ph-eye"></i> Detail Jurusan</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-borderless">
                        <tr>
                            <th width="35%">Kode Jurusan</th><td width="5%">:</td>
                            <td><span class="badge badge-secondary">{{ $jurusan->kode_jurusan }}</span></td>
                        </tr>
                        <tr>
                            <th>Nama Jurusan</th><td>:</td>
                        ...
                        <tr>
                            <th>Total Kelas</th><td>:</td>
                            <td><span class="badge badge-info">{{ $jurusan->kelas_count ?? 0 }} Kelas</span></td>
                        </tr>
                        <tr>
                            <th>Dibuat Pada</th><td>:</td>
...
<div class="modal fade" id="addJurusanModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title"><i class="ph ph-plus-circle"></i> Tambah Jurusan Baru</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
...
<div class="modal fade" id="editJurusanModal{{ $jurusan->id_jurusan }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title"><i class="ph ph-pencil"></i> Edit Jurusan</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
...
<div class="modal fade" id="deleteJurusanModal{{ $jurusan->id_jurusan }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title"><i class="ph ph-trash"></i> Hapus Jurusan</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="text-center mb-3">
...
<div class="modal fade" id="viewKelasModal{{ $k->id_kelas }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="ph ph-eye"></i> Detail Kelas</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-borderless">
                        <tr>
                            <th width="35%">Nama Kelas</th><td width="5%">:</td>
                        ...
                        <tr>
                            <th>Kapasitas</th><td>:</td>
                            <td>{{ $k->kapasitas }} orang</td>
                        </tr>
                        <tr>
                            <th>Jumlah Siswa</th><td>:</td>
                            <td>
                                <span class="badge badge-{{ ($k->siswa_count ?? 0) > ($k->kapasitas ?? 0) ? 'danger' : 'success' }}">
                                    {{ $k->siswa_count ?? 0 }}/{{ $k->kapasitas ?? 0 }}
                                </span>
...
<div class="modal fade" id="addKelasModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title"><i class="ph ph-plus-circle"></i> Tambah Kelas Baru</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
...
<div class="modal fade" id="editKelasModal{{ $k->id_kelas }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title"><i class="ph ph-pencil"></i> Edit Kelas</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
...
<div class="modal fade" id="deleteKelasModal{{ $k->id_kelas }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title"><i class="ph ph-trash"></i> Hapus Kelas</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="text-center mb-3">
...
<div class="modal fade" id="viewRuanganModal{{ $ruangan->id_ruangan }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="ph ph-eye"></i> Detail Ruangan</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-borderless">
                        <tr>
                            <th width="35%">Kode Ruangan</th><td width="5%">:</td>
                            <td><span class="badge badge-secondary">{{ $ruangan->kode_ruangan }}</span></td>
                        </tr>
                        <tr>
                            <th>Nama Ruangan</th><td>:</td>
                            <td><strong>{{ $ruangan->nama_ruangan }}</strong></td>
                        </tr>
                        <tr>
                            <th>Jenis Ruangan</th><td>:</td>
                            <td>{{ $ruangan->jenis_ruangan }}</td>
                        </tr>
                        <tr>
                            <th>Lokasi</th><td>:</td>
                        ...
                        <tr>
                            ...
                            <td>
                                @php
                                    ...
                                    if ($createdAt) {
                                        echo ($createdAt instanceof \Carbon\Carbon)
...
<div class="modal fade" id="addRuanganModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title"><i class="ph ph-plus-circle"></i> Tambah Ruangan Baru</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <form action="{{ route('admin.ruangan.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label>Jenis Ruangan <span class="text-danger">*</span></label>
...
<div class="modal fade" id="editRuanganModal{{ $ruangan->id_ruangan }}" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title"><i class="ph ph-pencil"></i> Edit Ruangan</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
...
<div class="modal fade" id="deleteRuanganModal{{ $ruangan->id_ruangan }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title"><i class="ph ph-trash"></i> Hapus Ruangan</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="text-center mb-3">
        ...
        <div class="card bg-light">
            <div class="card-body">
                <div class="d-flex align-items-start">
                    <i class="ph ph-info ph-2x text-primary mr-3" style="font-size: 1.5rem;"></i>
                    <div>
