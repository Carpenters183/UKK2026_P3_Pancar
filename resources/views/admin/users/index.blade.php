                ...
                <ul class="nav nav-tabs card-header-tabs" id="userTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="admin-tab" data-toggle="tab"
                            href="#tab-admin" role="tab">
                            <i class="ph ph-shield-check"></i> Admin
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="guru-tab" data-toggle="tab"
                            href="#tab-guru" role="tab">
                            <i class="ph ph-chalkboard-teacher"></i> Guru
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="siswa-tab" data-toggle="tab"
                            href="#tab-siswa" role="tab">
                            <i class="ph ph-users"></i> Siswa
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="petugas-tab" data-toggle="tab"
                            href="#tab-petugas" role="tab">
                ...
                <div class="tab-content" id="userTabContent">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="badge badge-info">{{ $guru->kelas->nama_kelas }}</span>
                                            @else
                                        ...
                                        <td>
                                            <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#viewGuruModal{{ $guru->id }}">
                                                <i class="ph ph-eye"></i>
                                            </button>
                                            <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editGuruModal{{ $guru->id }}">
                                                <i class="ph ph-pencil"></i>
                                            </button>
                                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteGuruModal{{ $guru->id }}">
                                                <i class="ph ph-trash"></i>
                                            </button>
                                        </td>
                                    </tr>
                    ...
                    <div class="tab-pane fade" id="tab-siswa" role="tabpanel">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div>
                                <button type="button" class="btn btn-info btn-sm mr-1" data-toggle="modal" data-target="#createSiswaModal">
                                    <i class="ph ph-plus"></i> Tambah Siswa
                                </button>
                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#importSiswaModal">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#viewSiswaModal{{ $siswa->id }}">
                                                <i class="ph ph-eye"></i>
                                            </button>
                                            <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editSiswaModal{{ $siswa->id }}">
                                                <i class="ph ph-pencil"></i>
                                            </button>
                                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteSiswaModal{{ $siswa->id }}">
                                                <i class="ph ph-trash"></i>
                                            </button>
                                        </td>
                                    </tr>
                    ...
                    <div class="tab-pane fade" id="tab-petugas" role="tabpanel">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#createPetugasModal">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td><img src="{{ $p->foto_url }}" width="40" height="40" class="rounded-circle" style="object-fit: cover;"></td>
                                        <td>{{ $p->nip ?? '-' }}</td>
                                        <td>{{ $p->nama }}</td>
                                        ...
                                        <td>
                                            <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#viewPetugasModal{{ $p->id }}"><i class="ph ph-eye"></i></button>
                                            <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editPetugasModal{{ $p->id }}"><i class="ph ph-pencil"></i></button>
                                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deletePetugasModal{{ $p->id }}"><i class="ph ph-trash"></i></button>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3"><label>Jabatan <span class="text-danger">*</span></label>
                            <select name="jabatan" class="form-control" id="jabatanSelectCreate" required>
                        ...
                        <div class="col-md-6 mb-3" id="kelasFieldCreate" style="display: none;">
                            <label>Kelas yang Diampu <span class="text-danger">*</span></label>
                            <select name="id_kelas" class="form-control" id="kelasSelectCreate">
                        ...
                        <div class="col-md-6 mb-3"><label>Foto</label><input type="file" name="foto" class="form-control-file" accept="image/*"></div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.siswa.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="mb-3"><label>File Excel</label><input type="file" name="file_excel" class="form-control-file" accept=".xlsx,.xls,.csv" required></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
...
<div class="modal fade" id="deleteAdminModal{{ $admin->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <form action="{{ route('admin.admin.destroy', $admin->id) }}" method="POST" class="d-inline">@csrf @method('DELETE')
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-3 text-center">
                        <img src="{{ $guru->foto ? asset('storage/' . $guru->foto) : asset('assets/images/user/avatar-1.jpg') }}" width="100" height="100" class="rounded-circle" style="object-fit:cover;">
                    </div>
                    <div class="col-md-9">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3"><label>Jabatan</label>
                            <select name="jabatan" class="form-control" id="jabatanSelectEdit{{ $guru->id }}" required>
                        ...
                        <div class="col-md-6 mb-3" id="kelasFieldEdit{{ $guru->id }}" style="display: {{ $guru->jabatan == 'Wali Kelas' ? 'block' : 'none' }};">
                            ...
                            <select name="id_kelas" class="form-control" id="kelasSelectEdit{{ $guru->id }}">
                                <option value="">Pilih Kelas</option>
                                @php
...
<div class="modal fade" id="deleteGuruModal{{ $guru->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <form action="{{ route('admin.guru.destroy', $guru->id) }}" method="POST" class="d-inline">@csrf @method('DELETE')
                    <button type="submit" class="btn btn-danger">Hapus</button>
                </form>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><strong>Kelas:</strong> {{ $siswa->kelasRelasi->nama_kelas ?? $siswa->kelas ?? '-' }}</p>
                <p><strong>Jurusan:</strong> {{ $siswa->jurusanRelasi->nama_jurusan ?? $siswa->jurusan ?? '-' }}</p>
            ...
            <form action="{{ route('admin.siswa.update', $siswa->id) }}" method="POST" enctype="multipart/form-data">@csrf @method('PUT')
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3"><label>Kelas</label>
                            <select name="id_kelas" class="form-control" required>
                                <option value="">Pilih Kelas</option>
                                @foreach($allKelas as $kelas)
                        ...
                        <div class="col-md-6 mb-3"><label>Jurusan</label>
                            <select name="id_jurusan" class="form-control" required>
                                <option value="">Pilih Jurusan</option>
                                @foreach($allJurusan as $jurusan)
...
<div class="modal fade" id="deleteSiswaModal{{ $siswa->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <form action="{{ route('admin.siswa.destroy', $siswa->id) }}" method="POST" class="d-inline">@csrf @method('DELETE')
                    <button type="submit" class="btn btn-danger">Hapus</button>
                </form>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><strong>Status:</strong> <span class="badge badge-{{ $p->status == 'Aktif' ? 'success' : 'secondary' }}">{{ $p->status }}</span></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
            </div>
...
<div class="modal fade" id="deletePetugasModal{{ $p->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <form action="{{ route('admin.petugas.destroy', $p->id) }}" method="POST" class="d-inline">@csrf @method('DELETE')
                    <button type="submit" class="btn btn-danger">Hapus</button>
                </form>
            </div>
        </div>
...
<!-- JavaScript untuk tab Wali Kelas -->
<script>
    // Untuk Create Modal
    var jabatanSelectCreate = document.getElementById('jabatanSelectCreate');
    var kelasFieldCreate = document.getElementById('kelasFieldCreate');
    ...
    @foreach($gurus as $guru)
    (function() {
        var jabatanSelect = document.getElementById('jabatanSelectEdit{{ $guru->id }}');
        var kelasField = document.getElementById('kelasFieldEdit{{ $guru->id }}');

        if (jabatanSelect) {
            jabatanSelect.addEventListener('change', function() {
                if (this.value === 'Wali Kelas') {
                    kelasField.style.display = 'block';
                    var kelasSelect = kelasField.querySelector('select');
...
<script>
    $(document).ready(function() {
        // Active tab berdasarkan URL hash
