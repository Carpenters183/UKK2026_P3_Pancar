        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    ...
                    {{ session('success') }}
                    <button type="button" class="close" data-dismiss="alert"><span>&times;</span></button></button>
                </div>
                @endif
                ...
                <form method="POST" action="{{ route('siswa.aspirasi.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="id_kategori" class="form-control" id="kategoriSelect" required {{ $sisaKuota <= 0 ? 'disabled' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <select name="id_ruangan" class="form-control" required {{ $sisaKuota <= 0 ? 'disabled' : '' }}>
